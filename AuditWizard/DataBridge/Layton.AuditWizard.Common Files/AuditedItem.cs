...
#region Constructor
		...
		public AuditedItem(DataRow dataRow)
		{
			try
			{
				...
				{
					this.ItemID = (int)dataRow["_AUDITEDITEMID"];
			...
			{
				System.Windows.Forms.MessageBox.Show("Exception occured creating an AUDITEDITEM Object, please check database schema.  The message was " + ex.Message);
			}
		}
