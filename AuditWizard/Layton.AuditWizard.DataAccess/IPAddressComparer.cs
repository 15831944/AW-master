...
{
	public class IPAddressComparer
	{
		/// <summary>
        ...
        static public int ComapreIP(string ToCompare, string CompareAgainst)
        {
            // convert to long in case there is any zero padding in the strings
            if ((IPAddressToLongBackwards(ToCompare) == IPAddressToLongBackwards(CompareAgainst)))
            {
                return 0;
            }
            else if (IPAddressToLongBackwards(ToCompare) < IPAddressToLongBackwards(CompareAgainst))
            {
                return -1;
            }
            else
