...
#region AuditWizardDataAccess Class
	...
	public class AuditWizardDataAccess
	{
		...
		{ 
            ...
            {
                // any error here is serious - without a DB connection we really need to close and fix issue
                logger.Error("Failed to open connection to database using connection : " + cb.ToString(), ex);

                Utility.DisplayErrorMessage(
                    "An error has occurred whilst trying to connect to the SQL Server database." +
                    Environment.NewLine + Environment.NewLine +
                    "Please consult the log file for further information. The application will now close.");
		...
		/// <summary>
		/// Create an open connection aborting if any error
		/// </summary>
		/// <returns></returns>
		public SqlConnection CreateOpenConnection2()
		{
			SqlConnection sqlConn = null;
			...
			catch (Exception ex)
			{
				...
				_lastError = "Failed to open the AuditWizard Database, the error was : " + ex.Message;
				sqlConn = null;
			}
		...
		public DataTable GetDatabaseVersion()
		{
			...
			if (conn == null)
			{
				_lastError = "Failed to open database";
			}
			else
			{
				try
		...
		public int ApplicationAdd(InstalledApplication theApplication)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					...
					spParams[2].Value = theApplication.Version;
		...
		public int ApplicationAddInstance(int assetID, ApplicationInstance theApplication, out int applicationID, out int instanceID)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
                    ...
                    theApplication.Publisher = new ApplicationsDAO().RationalisePublisherNames(theApplication.Publisher);
		...
		public int AssetAdd(Asset theAsset)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
                    ...
                    spParams[11] = new SqlParameter("@cAgentVersion", SqlDbType.VarChar, 255);
                    spParams[11].Value = theAsset.AgentVersion;
					spParams[12] = new SqlParameter("@nParentAssetID", SqlDbType.Int);
					spParams[12].Value = (int)theAsset.ParentAssetID;
					spParams[13] = new SqlParameter("@nSupplierID", SqlDbType.Int);
					spParams[13].Value = (int)theAsset.SupplierID;
					spParams[14] = new SqlParameter("@bAlertsEnabled", SqlDbType.Int);
					spParams[14].Value = theAsset.AlertsEnabled;
                    spParams[15] = new SqlParameter("@nAssetTag", SqlDbType.Char, 255);
                    spParams[15].Value = theAsset.AssetTag;
					spParams[16] = new SqlParameter("@nReturnID", SqlDbType.Int);
					spParams[16].Direction = ParameterDirection.ReturnValue;
					//
					SqlCommand cmd = new SqlCommand("usp_asset_add", conn);
					cmd.CommandType = CommandType.StoredProcedure;
					cmd.Parameters.AddRange(spParams);
					cmd.ExecuteNonQuery();
					itemID = (int)spParams[16].Value;
				}
				catch(SqlException ex)
				{
					this.HandleSqlError(ex);
        ...
        public int AssetIDByAssetName(string assetName)
        {
            int itemId = 0;
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    ...
                    //
                    SqlCommand cmd = new SqlCommand("usp_asset_byassetname", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddRange(spParams);
                    cmd.ExecuteNonQuery();
        ...
        public int GetSupplierIDBySupplierName(string strSupplierName)
        {
            int itemId = 0;
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlParameter[] spParams = new SqlParameter[2];
                    spParams[0] = new SqlParameter("@cName", SqlDbType.VarChar, 255);
                    spParams[0].Value = strSupplierName;
                    spParams[1] = new SqlParameter("@nReturnID", SqlDbType.Int);
                    spParams[1].Direction = ParameterDirection.Output;
                    //
                    SqlCommand cmd = new SqlCommand("usp_supplierid_bysuppliername", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddRange(spParams);
                    cmd.ExecuteNonQuery();
                    itemId = (int)spParams[1].Value;
        ...
        public string GetContractNumberByAssetID(int iAssetID)
        {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("usp_contractid_byAssetid", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@itemID", SqlDbType.Int);
                    cmd.Parameters["@itemID"].Value = iAssetID;
                    ...
                    if (retValueParam.Value != DBNull.Value)
                        ContractID = retValueParam.Value.ToString();
                }
                catch (SqlException e)
                {
                    this.HandleSqlError(e);
		...
		public int AssetUpdate(Asset theAsset)
		{
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
                    ...
                    spParams[13] = new SqlParameter("@cAgentVersion", SqlDbType.VarChar, 255);
                    spParams[13].Value = theAsset.AgentVersion;
					spParams[14] = new SqlParameter("@bAlertsEnabled", SqlDbType.Int);
					spParams[14].Value = theAsset.AlertsEnabled;
                    spParams[15] = new SqlParameter("@cUniqueID", SqlDbType.VarChar ,255);
                    spParams[15].Value = theAsset.UniqueID;
                    spParams[16] = new SqlParameter("@cAssetTag", SqlDbType.VarChar, 255);
                    spParams[16].Value = theAsset.AssetTag;
					//
		...
		public DataTable EnumerateDeployedAssets()
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					SqlCommand cmd = new SqlCommand("usp_asset_enumerate_deployed", conn);
					cmd.CommandType = CommandType.StoredProcedure;
					new SqlDataAdapter(cmd).Fill(table);
				}
				catch (SqlException ex)
        ...
        public DataTable EnumerateSupportContractAssetAlerts()
        {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("usp_check_support_assetalerts", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    new SqlDataAdapter(cmd).Fill(alertsTable);
                }
                catch (SqlException ex)
		...
		/// <param name="applicationID"></param>
		/// <returns></returns>
		public DataTable GetAuditedItem(int itemID)
		{
			DataTable dataTable = new DataTable(TableNames.AUDITEDITEMS);
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					SqlCommand cmd = new SqlCommand("usp_get_auditeditem", conn);
					cmd.CommandType = CommandType.StoredProcedure;
					cmd.Parameters.Add("@itemID", SqlDbType.Int);
		...
		public int LicenseTypeAdd(LicenseType theLicenseType)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					SqlParameter[] spParams = new SqlParameter[3]; 
					spParams[0] = new SqlParameter("@cName", SqlDbType.VarChar ,255);
                    string strLicenseTypeName = PrepareSqlString(theLicenseType.Name, 255);                    
                    strLicenseTypeName = FormatSqlString(strLicenseTypeName);                    
					//spParams[0].Value =  PrepareSqlString(theLicenseType.Name ,255);
                    spParams[0].Value = strLicenseTypeName;
		...
		public string GetSetting(string key, bool decrypt)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
                    ...
                    //SqlParameter retValueParam = new SqlParameter("@retValue", SqlDbType.VarChar, 2056);
					retValueParam.Direction = ParameterDirection.Output;
					cmd.Parameters.Add(retValueParam);
					cmd.ExecuteNonQuery();
					//
        ...
        /// <summary>
        /// Return a table containing all support contract for assets
        /// </summary>
        /// <returns></returns>
        public DataTable EnumerateSupportContract()
        {
            DataTable SupportContractAssetTable = new DataTable(TableNames.ALERTS);
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("usp_supportcontractasset_enumerate", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    new SqlDataAdapter(cmd).Fill(SupportContractAssetTable);
                }
                catch (SqlException ex)
                {
                    this.HandleSqlError(ex);
            ...
            return SupportContractAssetTable;
        }
       ...
       public DataTable GetSupportContractDetailsByID(int iAssetID)
       {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("usp_supportcontract_assetid", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@itemID", SqlDbType.Int);
                    cmd.Parameters["@itemID"].Value = iAssetID;
        ...
        public int SelectCountUserData()
        {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                ...
                {
                    // Execute the stored procedure
                    using (SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM USERDATA_DEFINITIONS", conn))
                    {
                        lCount = Convert.ToInt32(cmd.ExecuteScalar());
                    }
                }
                catch (SqlException e)
                {
        ...
        public int GetAssetTypeIDByName(string aAssetTypeName)
        {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                ...
                {
                    SqlParameter[] spParams = new SqlParameter[2];
                    spParams[0] = new SqlParameter("@cAssetTypeName", SqlDbType.VarChar, 255);
                    spParams[0].Value = aAssetTypeName;
                    spParams[1] = new SqlParameter("@nReturnID", SqlDbType.Int);
                    spParams[1].Direction = ParameterDirection.Output;

                    // Execute the stored procedure
                    SqlCommand cmd = new SqlCommand("usp_assettype_byname", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddRange(spParams);
                    cmd.ExecuteNonQuery();
                    lAssetTypeId = (int)spParams[1].Value;
                }
                catch (SqlException ex)
                {
                    this.HandleSqlError(ex);
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					String sql = 	"SELECT 'row' " +
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE _LASTAUDIT is NULL AND _STOCK_STATUS < 3) notaudited " + 
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) = 0) AND _STOCK_STATUS < 3) today " + 
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) > 7) AND (datediff(day, _LASTAUDIT ,GETDATE()) <= 14) AND _STOCK_STATUS < 3) notinlast7 " + 
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) > 14) AND (datediff(day, _LASTAUDIT ,GETDATE()) <= 30) AND _STOCK_STATUS < 3) notinlast14 " + 
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) > 30) AND (datediff(day, _LASTAUDIT ,GETDATE()) <= 90) AND _STOCK_STATUS < 3) notinlast30 " + 
									",(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) > 90) AND _STOCK_STATUS < 3) over90days ";
        ...
        /// <summary>
        /// Return statistics for the 'Support Statistics Assets' phase
        /// </summary>
        /// <returns></returns>
        public DataTable SupportStatisticsAsset()
        {
            ...
            using (SqlConnection conn = CreateOpenConnection())
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("usp_support_statistics_assets", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    new SqlDataAdapter(cmd).Fill(statisticsTable);
                }
                catch (SqlException e)
		...
		public DataTable StatisticsTopOS(int recordCount)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
                    ...
                    //string SQLStatement = "SELECT APPLICATIONS._NAME,(SELECT COUNT(*) " +
                    ...
                    //string SQLStatement = "SELECT APPLICATIONS._NAME " +
                    //                        "FROM APPLICATIONS " +
                    ...
                    //SQLDataAdapter.Fill(statisticsTable);
		...
		public int DatabasePurgeAssets(DateTime purgeBeforeDate)
		{
			...
			using (SqlConnection conn = CreateOpenConnection())
			{
				try
				{
					...
					spParams[0] = new SqlParameter("@dtPurgeDate", SqlDbType.DateTime);
					spParams[0].Value = purgeBeforeDate;
					SqlCommand cmd = new SqlCommand("usp_unauditedassets_purge", conn);
					cmd.CommandType = CommandType.StoredProcedure;
					cmd.Parameters.AddRange(spParams);
					rowsReturned = cmd.ExecuteNonQuery();
				}
		...
		protected DateTime GetPurgeDate(int count, DatabaseSettings.PURGEUNITS units)
		{
			...
			switch ((int)units)
			{
				...
				case (int)DatabaseSettings.PURGEUNITS.years:
					purgeBeforeDate.AddYears(-count);
					break;
			}
		...
		public String BuildPublisherFilter(String delimitedFilter)
		{
			String returnFilter = "";
			if (delimitedFilter != "")
			{
		...
		{
            logger.Error("SqlException in AuditWizardDataAccess.", exception);
            Utility.DisplayErrorMessage("An error has occurred connecting to SQL Server database.");
        ...
        /// <summary>
        /// added by Sojan E John, KtsInfotech
        /// Helper Function - Prepare a character string by removing the leading and trailing " ' "  character
        /// added after PrepareSqlString function 
        /// This is added to solve bug no 838
        /// </summary>
        /// <param name="strInputString"></param>
        /// <returns></returns>
        protected string FormatSqlString(string strInputString)
        {
            string strOutputString = strInputString.Remove(0, 1);
            strOutputString = strOutputString.Remove(strOutputString.Length - 1, 1);
		...
		/// <summary>
		/// 8.3.4 - CMD
		/// Static string preparer to catch strings with invalid characters in them used in external queries
		/// </summary>
		/// <param name="strInputString"></param>
		/// <returns></returns>
		public static string PrepareSqlString (string strInputString)
		{
			int nMaxLen=255;
			string newString = "'";
			int nLen = strInputString.Length;
