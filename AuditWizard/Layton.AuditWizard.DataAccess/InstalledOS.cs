...
#region Constructor
		...
		public InstalledOS(DataRow dataRow)
		{
			...
			catch (Exception ex)
			{
				...
				Utility.DisplayErrorMessage("Exception occurred creating an INSTALLEDOS Object, please check database schema.  The message was " + ex.Message);
			}
		}
...
#region Methods
        ...
        public bool IsCompliant()
        {
            ...
            int licenseCount = GetLicenseCount(this.Licenses);
            if (licenseCount == -1)
                return true;
