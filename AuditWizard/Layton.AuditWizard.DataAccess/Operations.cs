...
namespace Layton.AuditWizard.DataAccess
{
	...
	public class Operation
	{
		...
		public enum OPERATION { any = -1, deployagent, startagent, stopagent, removeagent, clearagentlog, reaudit, checkstatus, updateconfiguration };
		...
		public string OperationAsString
		{
			get
			{
				...
				switch ((int)_operation)
				{
					...
					case (int)OPERATION.updateconfiguration: value = "Update Configuration"; break;
		...
		public Operation(DataRow dataRow)
		{
			...
			catch (Exception ex)
			{
				...
				Utility.DisplayErrorMessage("Exception occurred creating an OPERATION Object, please check database schema.  The message was " + ex.Message);
			}
		}
