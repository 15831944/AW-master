...
namespace Layton.AuditWizard.DataAccess
{
	...
	public class Asset
	{
		...
		public string LastAuditDateString
		{
			get
			{
				if (this._lastAudit.Ticks != 0L)
				{
                    ...
                    return this._lastAudit.ToString("yyyy-MM-dd HH:mm");
				}
				return "<not audited>";
			}
		}
		...
		public string AgentStatusText
		{
			get
			{
			  ...
			  : (AgentStatus == Asset.AGENTSTATUS.deployed) ? "Not Running" : "Running";
			}
		}
        ...
        {
            get { return this._assetTag; }
            set { this._assetTag = value; }
        }
        ...
        {
            get { return _overwriteData; }
            set { _overwriteData = value; } 
        }
    ...
    public class SupportContract 
    {
        ...
        {
            get { return strContractNumber; }
            set { strContractNumber = value; }
        }
        private int iContractValue;

        public int ContractValue
        {
            get { return iContractValue; }
            set { iContractValue = value; }
        }
        ...
        private bool strAlertFlag;

        public bool AlertFlag
        {
            get { return strAlertFlag; }
            set { strAlertFlag = value; }
        }
        private int iNoOfDays;

        public int NoOfDays
        {
            get { return iNoOfDays; }
            set { iNoOfDays = value; }
        }
        private bool strAlertByEmail;

        public bool AlertByEmail
        {
            get { return strAlertByEmail; }
            set { strAlertByEmail = value; }
        }
        ...
        public SupportContract()
        {
            ...
            strContractNumber = "";
            strAlertFlag = false;
            strAlertByEmail=false;
            iContractValue = 0;
            iNoOfDays = 0;
            dtExpiryDate = new DateTime(0L);
            strNotes = "";
            strSupplier = "";
