...
[assembly: AssemblyCopyright("Copyright ©  2005 Infragistics, Inc.")]
...
class AssemblyRef
{
	...
	internal const string AssemblyName = "Infragistics.Practices.CompositeUI.WinForms.v" + Infragistics.Shared.AssemblyVersion.MajorMinor;
	internal const string AssemblyProduct = "Infragistics.Practices.CompositeUI.WinForms";
	internal const string AssemblyDescriptionBase = "Infragistics Composite UI WinForms Application Block";
