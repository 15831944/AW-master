...
namespace Layton.Common.Controls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		protected Font normalTitleFont = new Font("Verdana",12,FontStyle.Regular,GraphicsUnit.Pixel);
		protected Font hoverTitleFont = new Font("Verdana",12,FontStyle.Bold,GraphicsUnit.Pixel);
		protected Font normalContentFont = new Font("Verdana",11,FontStyle.Regular,GraphicsUnit.Pixel);
		protected Font hoverContentFont = new Font("Verdana",11,FontStyle.Regular,GraphicsUnit.Pixel);
		...
		protected StringAlignment contentAlignment = StringAlignment.Center;
		...
		/// <summary>
		/// Get/Set the Title text Alignment
		/// </summary>
		...
		protected void DrawText(Graphics grfx)
		{
			if (titleText != null && titleText.Length != 0)
			{
				...
				sf.LineAlignment = titleAlignment;
			...
			{
				StringFormat sf = new StringFormat();
				sf.Alignment = contentAlignment;
				sf.LineAlignment = contentAlignment;
		...
		protected void CalculateMouseRectangles()
		{
			...
			sfTitle.Alignment = titleAlignment;
			sfTitle.LineAlignment = titleAlignment;
			sfTitle.FormatFlags = StringFormatFlags.MeasureTrailingSpaces;
			//
			StringFormat sfContent = new StringFormat();
			sfContent.Alignment = contentAlignment;
			sfContent.LineAlignment = contentAlignment;
			sfContent.FormatFlags = StringFormatFlags.MeasureTrailingSpaces;
			SizeF sizefTitle = grfx.MeasureString(titleText, hoverTitleFont, TitleRectangle.Width, sfTitle);
			SizeF sizefContent = grfx.MeasureString(contentText, hoverContentFont, ContentRectangle.Width, sfContent);
			grfx.Dispose();
