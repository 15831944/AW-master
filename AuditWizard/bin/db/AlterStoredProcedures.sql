...
ALTER PROCEDURE [dbo].[usp_users_enumerate]
AS  
...
ALTER PROCEDURE [dbo].[usp_preparestring]	@cInString varchar(5000),
...
ALTER PROCEDURE [dbo].[usp_IdentityInsert]	
...
ALTER PROCEDURE [dbo].[usp_applications_enumerate]
...
ALTER PROCEDURE [dbo].[usp_applications_enumerate_aliases]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_application_alias_count]
	@applicationID int
AS  
...
ALTER PROCEDURE [dbo].[usp_get_application]
	@nApplicationID int
AS  
	SELECT APPLICATIONS.*
		FROM APPLICATIONS
...
ALTER PROCEDURE [dbo].[usp_asset_applications_enumerate]
	@assetID int,
	@forPublisher varchar(5000),
	@showIncluded bit,
	@showIgnored bit
...
ALTER PROCEDURE [dbo].[usp_os_enumerate]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_asset_getos]
	@assetID int
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_update]
	@nAssetID int,
	@cName varchar(255),
	@nLocationID int,
	@nDomainID int,
	...
	@nSupplierID int,
	@nStockStatus int,
	@cAgentVersion varchar(255),
	@bAlertsEnabled bit,
	@cUniqueID varchar(255),
	@cAssetTag varchar(255)
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_asset_getdetails]
	@nAssetID int
AS
...
ALTER PROCEDURE [dbo].[usp_publishers_enumerate]
...
ALTER PROCEDURE [dbo].[usp_statistics_topapplications]
						@resultCount int,
...
ALTER PROCEDURE [dbo].[usp_statistics_toppublishers]
						@resultCount int,
						@publisherFilter varchar(1024)
AS	
BEGIN
...
ALTER PROCEDURE [dbo].[usp_statistics_msoffice]
						@resultCount int
AS	
BEGIN
    SET ROWCOUNT @RESULTCOUNT 
...
ALTER PROCEDURE [dbo].[usp_statistics_auditeditems]
						@resultCount int,
...
ALTER PROCEDURE [dbo].[usp_statistics_assettypes]
AS
BEGIN
...
ALTER PROCEDURE [dbo].[usp_licensetype_delete]
	@nLicenseTypeID int
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_license_delete]
	@nLicenseID int
AS     
	--SET nocount ON
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_licenses_enumerate]
	@nLicenseTypeID int
AS   
...
ALTER PROCEDURE [dbo].[usp_audittrail_enumerate]
	@nClass int
AS 
...
ALTER PROCEDURE [dbo].usp_audittrail_getassethistory
	@nAssetID int,
...
ALTER PROCEDURE [dbo].[usp_audittrail_lastauditdate]
	@nAssetID int,
	@nDays	int,
	@bAudited bit
...
ALTER PROCEDURE [dbo].[usp_applicationinstance_enumerate]
	@applicationID int
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_application_changepublisher]
	@applicationID int,
...
ALTER PROCEDURE [dbo].[usp_audit_statistics]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_statistics_auditdates]
AS	
BEGIN
	...
	SELECT 'row'
		...
		,(SELECT COUNT(_ASSETID) FROM ASSETS WHERE (datediff(day, _LASTAUDIT ,GETDATE()) > 30) AND (datediff(day, _LASTAUDIT ,GETDATE()) <= 90)) notinlast30
...
ALTER PROCEDURE [dbo].[usp_application_set_ignored]
	@nApplicationID int,
	@bIgnore bit
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_action_enumerate]
AS 
	DECLARE @cSQL varchar(1024) 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_action_delete]
	@nActionID int
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_applicationinstance_getcount]
AS     
...
ALTER PROCEDURE [dbo].[usp_add_application]
...
ALTER PROCEDURE [dbo].[usp_application_alias]
...
ALTER PROCEDURE [dbo].[usp_check_support_alerts]
AS
...
ALTER PROCEDURE [dbo].[usp_statistics_dl]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_statistics_topos]
@resultCount int
AS	
BEGIN
    SET ROWCOUNT @resultCount
    SELECT APPLICATIONS._NAME, COUNT(*) AS t FROM APPLICATION_INSTANCES, APPLICATIONS
                            WHERE APPLICATION_INSTANCES._APPLICATIONID = APPLICATIONS._APPLICATIONID
                            AND APPLICATIONS._ISOS = 1
...
ALTER PROCEDURE [dbo].[usp_applicationlicense_enumerate]
	@applicationID int
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].usp_supportcontract_enumerate
AS
...
ALTER PROCEDURE [dbo].[usp_os_statistics]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_add_os]
	@cName	varchar(255),
	@cVersion varchar(255),
	@nReturnId int output
AS
...
ALTER PROCEDURE [dbo].[usp_application_deleteorphans]
AS  
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_osinstance_getcount]
AS     
	DECLARE @nReturnCount int
	--SET nocount ON
	SET @nReturnCount = (SELECT count(*) FROM APPLICATION_INSTANCES 
...
ALTER PROCEDURE [dbo].[usp_supplier_update]
	@nSupplierID int,
	@cName		varchar(255),
...
ALTER PROCEDURE [dbo].[usp_supplier_find]
	@cName varchar(255)
AS
	DECLARE @nReturnID int
...
ALTER PROCEDURE [dbo].[usp_supplier_enumerate]
AS 
	DECLARE @cSQL varchar(1024) 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_supplier_delete]
	@nSupplierID int
AS     
	DECLARE @cSQL as varchar(255)
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_statistics_da]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_statistics_assets]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_statistics_asset_states]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_applicationinstance_update]
	@nInstanceID		int,
...
ALTER PROCEDURE [dbo].[usp_add_application_instance]
	@nAssetID int,
	@nApplicationID int,
	@cProductID varchar(255),
	@cCDKey varchar(255),
...
ALTER PROCEDURE [dbo].[usp_applicationinstance_delete]
	@forAssetID int
AS  
	--SET nocount ON  	
...
ALTER PROCEDURE [dbo].[usp_asset_statistics]
	@oldAuditDays int
AS  
...
ALTER PROCEDURE [dbo].[usp_statistics_topassets]
						@resultCount int,
						@publisherFilter varchar(1024)
AS	
BEGIN
...
ALTER PROCEDURE [dbo].[usp_audittrail_delete]
	@nAuditTrailID int
AS  
	--SET nocount ON  	
...
ALTER PROCEDURE [dbo].[usp_audittrail_purge]
...
ALTER PROCEDURE [dbo].[usp_support_statistics]
AS 
	DECLARE @dtToday DateTime
...
ALTER PROCEDURE [dbo].[usp_statistics_alerts]
AS  
	DECLARE @dtToday DateTime
	DECLARE @dtThisWeek DateTime
	DECLARE @dtThisMonth DateTime
...
ALTER PROCEDURE [dbo].[usp_license_update]
	@nLicenseID int,
	@nLicenseTypeID int,
	@nApplicationID int,
	@nCount int,
...
ALTER PROCEDURE [dbo].[usp_licensetype_update]
	@nLicenseTypeID int,
	@bPerPC bit
...
ALTER PROCEDURE [dbo].[usp_licensetype_find]
	@cName varchar(255)
AS
	DECLARE @nReturnID int
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_licensetype_enumerate]
AS
BEGIN
	-- --SET nocount ON added to prevent extra result sets from
	-- interfering with SELECT statements.
...
ALTER PROCEDURE [dbo].[usp_action_update]
	@nActionID INT,
	@nStatus INT,
...
ALTER PROCEDURE [dbo].[usp_statistics_ca]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_statistics_ra]
AS  
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_settings_setsetting]
	@key varchar(255),
	@value varchar(255)
...
ALTER PROCEDURE [dbo].[usp_settings_getsetting]
	@key varchar(255),
...
ALTER PROCEDURE [dbo].[usp_add_user]
	@cLogin varchar(255),
	@cFirstName varchar(255),
	@cLastName	varchar(255),
	@nAccessLevel int,
...
ALTER PROCEDURE [dbo].[usp_user_setpassword]
	@nUserID int,
...
ALTER PROCEDURE [dbo].[usp_user_checkpassword]
	@cLogin varchar(255),
	@cPassword varchar(255),
	@nReturnID int output
...
ALTER PROCEDURE [dbo].[usp_SetVersion] 
					@intMajor as int,
					@intMinor as int,
...
ALTER PROCEDURE [dbo].[usp_get_version] 
AS
...
ALTER PROCEDURE [dbo].[usp_alert_enumerate]
...
ALTER PROCEDURE [dbo].[usp_alert_purge]
	@dtPurgeDate DateTime
AS  
	DECLARE @nRowCount int
...
ALTER PROCEDURE [dbo].[usp_alert_update]
	@nAlertID int,
...
ALTER PROCEDURE [dbo].usp_alert_delete
	@nAlertID int
...
ALTER PROCEDURE [dbo].[usp_audittrail_add]
	@nAssetID int,
...
ALTER PROCEDURE [dbo].[usp_licensetype_add]
	@cName varchar(255),
	@bPerPC bit,
	@nReturnID int output
AS
...
ALTER PROCEDURE [dbo].[usp_license_add]
	@nLicenseTypeID int,
...
ALTER PROCEDURE [dbo].[usp_action_add]
	@nType int,
	@nApplicationID int,
	@nStatus int,
	@cAssets varchar(5000),
...
ALTER PROCEDURE [dbo].[usp_alert_add]
	@nType int,
	@nCategory int,
...
ALTER PROCEDURE [dbo].[usp_alert_set_status]
	@nAlertID int,
	@nStatus int
AS     
	--SET nocount ON 
...
ALTER PROCEDURE [dbo].[usp_supplier_add]
	@cName	varchar(255),
	@cAddress1	varchar(255),
	@cAddress2	varchar(255),
	@cCity		varchar(255),
...
ALTER PROCEDURE [dbo].[usp_asset_find]
	@cName varchar(255),
	@cUniqueID varchar(255)
AS
...
ALTER PROCEDURE [dbo].[usp_asset_requestaudit]
	@nAssetID int,
	@bSetOrClear bit
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_update_agent_status]
	@nAssetID int,
	@nAgentStatus int	
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_update_stock_status]
	@nAssetID int,
	@nStockStatus int	
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_set_lastauditdate]
	@nAssetID int,
	@dtDate	DateTime
AS     
	DECLARE @cSQL varchar(510)
...
ALTER PROCEDURE [dbo].[usp_asset_set_parent]
	@nAssetID int,
	@nParentID int
AS     
	DECLARE @cSQL varchar(510)
...
ALTER PROCEDURE [dbo].[usp_asset_hide]
	@nAssetID int,
	@bHideOrShow bit
AS     
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_getcount]
	@bAuditedOnly bit,
	@bVisibleOnly bit
AS     
	DECLARE @cSQL as varchar(255)
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_asset_enumerate]
	@nLocationID	int,
	@nDomainID		int,
	@showStock		bit,
	@showinUse		bit,
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_asset_enumerate_deployed]
AS
BEGIN
...
-- Description:	Returns a table of assets
-- =============================================
ALTER PROCEDURE [dbo].[usp_asset_enumerate_alerts_disabled]
AS
BEGIN
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_childasset_enumerate]
	@nAssetID	int
AS
BEGIN
...
ALTER PROCEDURE [dbo].[usp_asset_add]
@cUniqueID varchar(255),
	@cName varchar(255),
	@nLocationID int,
	@nDomainID int,
...
BEGIN
	...
	BEGIN 			                         
		...
		INSERT INTO ASSETS
			(_UNIQUEID ,_NAME ,_LOCATIONID ,_DOMAINID ,_IPADDRESS ,_MACADDRESS ,_ASSETTYPEID ,_MAKE ,_MODEL ,_SERIAL_NUMBER ,_PARENT_ASSETID ,_SUPPLIERID ,_STOCK_STATUS ,_AGENT_VERSION ,_ALERTS_ENABLED, _OVERWRITEDATA, _ASSETTAG)
		VALUES
			(@cUniqueID, @cName, @nLocationID ,@nDomainID ,@cIPAddress ,@cMACAddress ,@nAssetTypeID ,@cMake ,@cModel ,@cSerial ,@nParentAssetID ,@nSupplierID ,@nStockStatus, @cAgentVersion ,@bAlertsEnabled, '1', @nAssetTag)
	...
	ELSE
		BEGIN
			EXEC usp_asset_update @nReturnID ,@cName ,@nLocationID ,@nDomainID ,@cIPAddress ,@cMACAddress ,@nAssetTypeID ,@cMake ,@cModel ,@cSerial, @nParentAssetID ,@nSupplierID ,@nStockStatus ,@cAgentVersion ,@bAlertsEnabled ,@cUniqueID ,@nAssetTag
		END
END
RETURN  @nReturnID
GO
...
ALTER PROCEDURE [dbo].[usp_add_installed_application]
	@nAssetID int,
	@cPublisher varchar(255),
	@cApplication varchar(255),
	@cVersion varchar(255),
...
ALTER PROCEDURE [dbo].[usp_add_installed_os]
	@nAssetID int,
	@cName varchar(255),
	@cVersion varchar(255),
	@cProductID varchar(255),
...
ALTER PROCEDURE [dbo].[usp_asset_delete_tables]
	@nAssetID int
AS    
BEGIN 
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_asset_delete]
	@nAssetID int
AS    
BEGIN 
	--SET nocount ON
...
ALTER PROCEDURE [dbo].[usp_get_security]
	@bEnabled bit output
...
ALTER PROCEDURE [dbo].[usp_set_security]
	@bEnable bit
...
IF EXISTS(SELECT * FROM dbo.sysobjects WHERE type = 'P' AND name = 'usp_assettype_byname')
     DROP PROCEDURE usp_assettype_byname
GO

CREATE PROCEDURE [dbo].[usp_assettype_byname]
	@cAssetTypeName varchar(510),
	@nReturnID int output
AS

	--SET nocount ON
	SET @nReturnID = isnull((SELECT _ASSETTYPEID FROM ASSET_TYPES WHERE _NAME=@cAssetTypeName),-1)
	RETURN @nReturnID
...
IF EXISTS(SELECT * FROM dbo.sysobjects WHERE type = 'P' AND name = 'usp_asset_byassetname')
     DROP PROCEDURE usp_asset_byassetname
GO

CREATE PROCEDURE [dbo].[usp_asset_byassetname]
	@cName varchar(510),
	@nReturnID int output
AS
	--SET nocount ON
	SET @nReturnID = isnull((SELECT MIN(_ASSETID) FROM ASSETS WHERE _NAME=@cName),-1)
	RETURN @nReturnID
...
ALTER PROCEDURE [dbo].[usp_assettype_enumerate]
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_assettype_add]
	@cName varchar(255),
	@nParentID int,
	@bAuditable bit,
	@cIcon varchar(255),
...
ALTER PROCEDURE [dbo].[usp_assettype_delete]
	@nAssetTypeID int
AS    
...
ALTER PROCEDURE [dbo].[usp_assettype_update]
	@nAssetTypeID int,
	@cName varchar(255),
	@nParentID int,
	@cIcon varchar(255)
...
ALTER PROCEDURE [dbo].[usp_udd_enumerate]
	@nScope int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_udd_add]
	@cName 		 varchar(255), 
	@nParentID	int,
	@bIsMandatory int,
	@nType		int,
...
ALTER PROCEDURE [dbo].[usp_udd_update]
	@nUserDefID		int,
	@nCategoryID	int,
	@cName 			varchar(255), 
	@bIsMandatory	int,
...
ALTER PROCEDURE [dbo].[usp_udd_delete]
	@nUserDataID int
AS     
	DECLARE @nParentID int,
			@nReferences int,
...
ALTER PROCEDURE [dbo].[usp_picklist_enumerate]
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_pickitem_enumerate]
	@nPicklistID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_picklist_add]
	@cName 		 varchar(255), 
	@nParentID	int,
	@nReturnID 	int output
AS
...
ALTER PROCEDURE [dbo].[usp_picklist_update]
	@nPicklistID int,
	@cName 		 varchar(255) 
AS
...
ALTER PROCEDURE [dbo].[usp_picklist_delete]
	@nPicklistID int
AS  
DECLARE @nRetCode int
...
ALTER PROCEDURE [dbo].[usp_set_organization]
...
ALTER PROCEDURE [dbo].[usp_locations_enumerate]  
	@nParentID int,
	@bShowAll bit
AS
	DECLARE @cSql varchar(1024) 
...
ALTER PROCEDURE [dbo].[usp_locations_enumerate_all]  
AS
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_location_add]
...
ALTER PROCEDURE [dbo].[usp_location_update]
	@nLocationID int,
	@cFullName 	 varchar(255),
	@cName 		 varchar(255),
	@nParentID	int,
...
ALTER PROCEDURE [dbo].[usp_location_delete]
	@nLocationID int
AS  
DECLARE @nRetCode int,
...
ALTER PROCEDURE [dbo].[usp_location_find]
...
ALTER PROCEDURE [dbo].[usp_domains_enumerate]  
	@nParentID int,
	@bShowAll bit
AS
	DECLARE @cSql varchar(1024) 
...
ALTER PROCEDURE [dbo].[usp_domain_add]
	@cName 		varchar(255), 
	@nParentID	int,
	@bHidden	bit,
	@nReturnID 	int output
...
ALTER PROCEDURE [dbo].[usp_domain_update]
	@nDomainID	int,
	@cName 		varchar(255),
	@nParentID	int,
	@bHidden	bit
...
ALTER PROCEDURE [dbo].[usp_domain_delete]
	@nDomainID int
AS  
DECLARE @nRetCode int
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_auditeditems_enumerate]
	@assetID int,
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].usp_auditeditems_enumerateicons
AS   
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_auditeditems_enumerate_categories]
	@parentCategory varchar(1024)
AS   
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_auditeditems_enumerate_category_names]
	@parentCategory varchar(1024)
AS   
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_auditeditems_enumerate_values]
	@assetID int,
...
ALTER PROCEDURE [dbo].[usp_auditeditems_delete]
	@forAssetID int
AS  
	--SET nocount ON 
	IF @forAssetID <> 0		
...
ALTER PROCEDURE [dbo].[usp_auditeditem_add]
	@cCategory varchar(1024),
	@cName varchar(1024),
	@cValue varchar(1024),
	@cIcon varchar(255),
...
ALTER PROCEDURE [dbo].[usp_get_auditeditem]
	@itemID int
AS  
	SELECT *
		FROM AUDITEDITEMS
...
ALTER PROCEDURE [dbo].[usp_statistics_topprocessorspeeds]
AS	
BEGIN
...
ALTER PROCEDURE [dbo].[usp_statistics_topmemorycapacity]
AS	
BEGIN
...
ALTER PROCEDURE [dbo].[usp_notes_enumerate]
	@nScope int,
	@nParentID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_note_add]
	@dtDate DateTime,
	@nScope	int,
	@nParentID int,
	@cText varchar(4000),
...
ALTER PROCEDURE [dbo].[usp_note_delete]
	@nNoteID int
AS    
...
ALTER PROCEDURE [dbo].[usp_note_update]
	@nNoteID int,
	@cText varchar(4000)
...
ALTER PROCEDURE [dbo].[usp_documents_enumerate]
	@nScope int,
	@nParentID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].usp_document_add
	@nScope	int,
	@nParentID int,
	@cName varchar(255),
	@cPath varchar(255),
...
ALTER PROCEDURE [dbo].usp_document_delete
	@nDocumentID int
AS    
...
ALTER PROCEDURE [dbo].usp_document_update
	@nDocumentID int,
	@cName varchar(255),
	@cPath varchar(255)
...
ALTER PROCEDURE [dbo].[usp_operations_enumerate]
	@nOperation int,
	@nStatus int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].usp_operation_add
	@nOperation	int,
	@nAssetID int,
	@nReturnID int output
AS
...
ALTER PROCEDURE [dbo].usp_operation_delete
	@nOperationID int
...
ALTER PROCEDURE [dbo].usp_operation_update
	@nOperationID int,
	@dtEndDate DateTime,
	@nStatus int,
...
ALTER PROCEDURE [dbo].usp_operation_lastindex
	@nReturnID int output
...
ALTER PROCEDURE [dbo].[usp_operations_purge]
	@dtPurgeDate DateTime
AS  
BEGIN
	DECLARE @nRowCount int
...
ALTER PROCEDURE [dbo].[usp_internet_purge]
	@dtPurgeDate DateTime
AS  
BEGIN
	DECLARE @nRowCount int
...
ALTER PROCEDURE [dbo].[usp_unauditedassets_purge]
	@dtPurgeDate DateTime
AS  
	DECLARE @nRowCount int
	...
	INSERT INTO @Tmp (_ASSETID) 
		SELECT _ASSETID FROM ASSETS 
			WHERE ( (_LASTAUDIT IS NOT NULL) AND (datediff(day, _LASTAUDIT, @dtPurgeDate) > 0) OR (_LASTAUDIT IS NULL))

	-- Now we select all of the records in the temporary table and loop through them deleting each asset
	SELECT @MaxRows = count(_ASSETID) FROM @Tmp	

	WHILE @nRowCount <= @MaxRows
	BEGIN
		select @ExecSql = 'exec ' + @Proc + ' ''' + CAST(_ASSETID AS NVARCHAR) + '''' from @Tmp where rownum = @nRowCount
...
ALTER PROCEDURE [dbo].usp_userdata_getvalues
	@nParentType	int,
	@nParentID		int,
	@nCategoryID	int
AS 
...
ALTER PROCEDURE [dbo].usp_userdata_update_value
	@nScope int,
	@nParentID int,
	@nUserDefID int,
	@cValue varchar(1020),
...
ALTER PROCEDURE [dbo].[usp_userdatafield_getvalues]
	@nFieldID	int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_internet_getdata]
	@dtStartDate DateTime,
	@dtEndDate DateTime,
	@strUrl varchar(510)
AS  
...
ALTER PROCEDURE [dbo].[usp_scanner_add]
	@cName	varchar(255),
	@cXML	Text,
	@nReturnID int output
AS
...
ALTER PROCEDURE [dbo].[usp_scanner_delete]
	@nScannerID int
AS     
	--SET nocount ON
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_scanner_enumerate]
	@cName varchar(255)
AS   
    -- Insert statements for procedure here
	IF (@cNAME = '')
...
ALTER PROCEDURE [dbo].[usp_scanner_update]
	@nScannerID int,
	@cName	varchar(255),
	@cXML	varchar(255)
...
ALTER PROCEDURE [dbo].[usp_fs_folder_enumerate]
	@nAssetID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_fs_file_enumerate]
	@nAssetID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].usp_fs_files_enumerate_assignments
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_fs_clean]
	@nAssetID int
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_fs_folder_add]
	@cName varchar(255),
	@nParentID int,
	@nAssetID int,
	@nReturnID int output
...
ALTER PROCEDURE [dbo].[usp_fs_file_add]
	@cName varchar(255),
	@nParentID int,
	@nAssetID int,
	@nSize int,
...
ALTER PROCEDURE [dbo].[usp_fs_file_report]
	@cFilter varchar(255)
AS 
	--SET nocount ON  
...
ALTER PROCEDURE [dbo].[usp_fs_file_assign]
	@cName			varchar(255),
	@cPublisher		varchar(255),
	@cProductName	varchar(255),
	@cFVersion1		varchar(255),
...
ALTER PROCEDURE [dbo].[usp_get_licensecount] 
AS
...
ALTER PROCEDURE [dbo].[usp_cleardown_database]
AS     
	--SET nocount ON
...
--																		--
--------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[usp_auditeditem_getname]
	@itemID int,
