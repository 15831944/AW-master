...
BEGIN
	...
	BEGIN 			                         
		...
		INSERT INTO ASSETS
			(_UNIQUEID ,_NAME ,_LOCATIONID ,_DOMAINID ,_IPADDRESS ,_MACADDRESS ,_ASSETTYPEID ,_MAKE ,_MODEL ,_SERIAL_NUMBER ,_PARENT_ASSETID ,_SUPPLIERID ,_STOCK_STATUS ,_AGENT_VERSION ,_ALERTS_ENABLED, _OVERWRITEDATA)
		VALUES
			(@cUniqueID, @cName, @nLocationID ,@nDomainID ,@cIPAddress ,@cMACAddress ,@nAssetTypeID ,@cMake ,@cModel ,@cSerial ,@nParentAssetID ,@nSupplierID ,@nStockStatus, @cAgentVersion ,@bAlertsEnabled, 'True')
	...
	ELSE
		BEGIN
			EXEC usp_asset_update @nReturnID ,@cName ,@nLocationID ,@nDomainID ,@cIPAddress ,@cMACAddress ,@nAssetTypeID ,@cMake ,@cModel ,@cSerial, @nParentAssetID ,@nSupplierID ,@nStockStatus ,@cAgentVersion ,@bAlertsEnabled
		END
END
RETURN  @nReturnID
GO
