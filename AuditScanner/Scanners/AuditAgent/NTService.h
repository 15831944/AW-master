...
class CNTService 
{
	...
	public:		// overridables
		...
		virtual void	Shutdown();
			...
			// Custom() is called when we receive ANY control code other than those 
			// explicitely defined for a service.  The derived class should implement
			// this function and return TRUE if the customer command has been 
			// handled of FALSE if it is unexpected
		virtual BOOL	CustomCommand(DWORD dwCtrlCode) = 0;
