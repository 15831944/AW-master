...
protected:
	...
	BOOL GetItemBinary_JML (HKEY hKey, LPCSTR pszSubKey, LPCSTR lpszValueName, CByteArray& return_array);
...
private:
	...
	// Data required to dynamically map RegDisableReflectionKey and RegEnableReflectionKey
	typedef DWORD   (WINAPI* pRegDisableReflectionKey)	(HANDLE hKey);
	typedef DWORD   (WINAPI* pRegEnableReflectionKey)	(HANDLE hKey);
	HINSTANCE	m_hAdvapi32;
	pRegDisableReflectionKey			m_pFnRegDisableReflectionKey;
	pRegEnableReflectionKey				m_pFnRegEnableReflectionKey;
};